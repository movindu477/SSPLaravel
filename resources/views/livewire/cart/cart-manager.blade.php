                ...
                @foreach($cartItems as $item)
                    <div wire:key="cart-item-{{ $item['item_id'] }}" class="bg-white rounded-lg shadow-sm p-4 flex flex-col sm:flex-row items-center gap-4 hover:shadow-md transition-shadow">
                        ...
                        <div class="flex items-center border border-gray-300 rounded-lg">
                            <button wire:click="updateQuantity({{ $item['item_id'] }}, -1)" wire:loading.attr="disabled" class="px-3 py-1 hover:bg-gray-100 text-gray-600">-</button>
                        ...
                        <div class="flex flex-col items-end gap-2 w-full sm:w-auto">
                            ...
                            <button wire:click="removeItem({{ $item['item_id'] }})" wire:loading.attr="disabled" class="text-red-500 hover:text-red-700 p-1 hover:bg-red-50 rounded transition-colors disabled:opacity-50" title="Remove Item">
