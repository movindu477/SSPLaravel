...
@if(!session('user_id'))
    <div class="min-h-screen bg-gray-50 py-12 flex items-center justify-center">
        <div class="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <a href="{{ route('login') }}" class="inline-block bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold transform hover:scale-105 transition-all duration-300">
                Go to Login
            </a>
        </div>
    </div>
            ...
            <div class="px-8 pb-8 -mt-16">
                <div class="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
                    <div class="relative">
                        ...
                        <button class="absolute bottom-0 right-0 bg-purple-600 text-white rounded-full p-2 hover:bg-purple-700 transition-colors shadow-lg">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <span class="bg-purple-100 text-purple-700 px-4 py-1 rounded-full text-sm font-medium">
                    ...
                    <button class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg">
                        Edit Profile
                    </button>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex gap-4">
                            <a href="{{ route('shop') }}" class="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-lg font-semibold text-center transform hover:scale-105 transition-all duration-300">
                                Continue Shopping
                            </a>
