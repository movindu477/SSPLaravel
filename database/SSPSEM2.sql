-- ============================================
-- SSPSEM2 Database Setup Script
-- Laravel Pet E-Commerce Application
-- ============================================
...
-- Add default constraint for created_at
ALTER TABLE [User] ADD CONSTRAINT DF_User_created_at DEFAULT GETDATE() FOR created_at;
GO

-- ============================================
-- Pets Table for Products
-- ============================================
-- Image paths are relative to Laravel's public folder
-- Format: 'images/filename.ext' maps to: public/images/filename.ext
-- Laravel's asset() helper converts this to: /images/filename.ext
CREATE TABLE Pets (
    id INT IDENTITY(1,1) PRIMARY KEY,
...
-- Add default constraint for created_at
ALTER TABLE Pets ADD CONSTRAINT DF_Pets_created_at DEFAULT GETDATE() FOR created_at;
GO

-- ============================================
-- Insert Dog Food Products
-- ============================================
...
-- ============================================
CREATE INDEX IX_Pets_PetType ON Pets(pet_type);
CREATE INDEX IX_Pets_AccessoriesType ON Pets(accessories_type);
CREATE INDEX IX_Pets_Price ON Pets(price);
...
-- Verify Data
-- ============================================
SELECT 'Total Products: ' + CAST(COUNT(*) AS VARCHAR) FROM Pets;
SELECT 'Dog Food: ' + CAST(COUNT(*) AS VARCHAR) FROM Pets WHERE pet_type = 'Dog' AND accessories_type = 'Food';
SELECT 'Dog Toys: ' + CAST(COUNT(*) AS VARCHAR) FROM Pets WHERE pet_type = 'Dog' AND accessories_type = 'Toy';
SELECT 'Cat Food: ' + CAST(COUNT(*) AS VARCHAR) FROM Pets WHERE pet_type = 'Cat' AND accessories_type = 'Food';
SELECT 'Cat Toys: ' + CAST(COUNT(*) AS VARCHAR) FROM Pets WHERE pet_type = 'Cat' AND accessories_type = 'Toy';
GO
...
FROM Pets 
WHERE image_url NOT LIKE 'images/%' AND image_url IS NOT NULL;
GO
